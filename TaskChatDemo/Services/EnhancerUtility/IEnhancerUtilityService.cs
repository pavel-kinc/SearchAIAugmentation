...
namespace TaskChatDemo.Services.EnhancerUtility
{
    ...
    public interface IEnhancerUtilityService
    {
        ...
        /// </summary>
        /// <param name="userInput">The query string used to search relevant context (user input).</param>
        ...
        Task<PipelineRun> GetContextFromPipeline(string userInput, bool skipPipeline, Entry entry, PipelineSettings settings);
