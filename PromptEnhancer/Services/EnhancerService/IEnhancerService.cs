...
namespace PromptEnhancer.Services.EnhancerService
{
    public interface IEnhancerService
    {
        ...
        public Task<ErrorOr<IList<ResultModel>>> ProcessPipeline(PipelineModel pipeline, IEnumerable<PipelineContext> entries, CancellationToken cancellationToken = default);
